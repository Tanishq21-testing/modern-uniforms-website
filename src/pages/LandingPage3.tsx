...
const LandingPage3 = () => {
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-4">Premium School Options</h2>
            <p className="text-xl text-gray-600 text-center mb-12">Designed to suit your students</p>
